  ...
  return (
    <div>
      ...
      <div className="px-8 py-6 space-y-5">
        ...
        {filteredItems && filteredItems.length === 0 && <EmptyState title={t("rangerReports.empty")} />}
                        ...
                        <div className="pt-1.5 flex items-center justify-between gap-2 border-t border-border/50">
                          {check ? (
                            <div className="flex items-center gap-1.5">
                              {ToneIcon && <ToneIcon size={12} weight="fill" className={TONE_TEXT_CLASS[tone!.tone]} />}
                              <Pill tone={tone!.tone} className="px-2 py-0.5 text-[9px]">
                                {tone!.label}
                              </Pill>
